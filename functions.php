...
function custom_excerpt_length($length) {
    return 20; // Replace 20 with your desired word count
}

function get_custom_excerpt($post_id, $length = 20) {
...
if ( ! function_exists( 'clearer_styles' ) ) {
	...
	function clearer_styles() {
		...
		wp_enqueue_style( 'clearer-mystyles', get_template_directory_uri().'/my-styles.css' );
